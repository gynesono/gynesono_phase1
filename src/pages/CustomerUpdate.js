...
class CustomerRegistation extends Component {
    ...
    handleUpdate = () => {
        ...
        this.setState({ psalu: this.props.psalu});
        this.setState({ pGender: this.props.pGender});
        this.setState({ PAge: this.props.PAge});
        this.setState({ pEmail: this.props.pEmail});
        this.setState({ pHusbandName: this.props.pHusbandName});
        this.setState({ pAddress: this.props.pAddress});
        ...
        return (
                                    ...
                                    <div className="mb-2 row">
                                        ...
                                        <div className="col-sm-4">
                                            ...
                                            <div className="form-check-inline">
                                                ...
                                                <input type="checkbox" value="yes" checked={this.state.pPortalConsent} onChange={e => this.setState({ pPortalConsent: e.target.value })} />
           ...
           minlength="10" maxlength="10" className="form-control"  value={this.state.mn} onChange={e => this.setState({ mn: e.target.value })} />
                                    ...
                                    <div className="mb-4 row">
                                        <div className="col-xl-4">&nbsp;<button className="btn btn-danger submit-btn" type="submit" >Update
                                            Customer</button>
                                        </div>
